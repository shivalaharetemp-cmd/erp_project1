...
def dashboard(request):
    ...
    ctx = {
        ...
        'intransit_vehicles': Vehicle.objects.filter(status='InTransit').count(),
        'delivered_vehicles': Vehicle.objects.filter(status='Delivered').count(),
        ...
        'recent_vehicles': Vehicle.objects.all().select_related(
            'transporter', 'party', 'loading_point'
