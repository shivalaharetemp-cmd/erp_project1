...
class Vehicle(models.Model):
    ...
    loading_point = models.ForeignKey(
        'masters.LoadingPoint', on_delete=models.PROTECT, related_name='vehicles',
    ...
    pod_reference = models.CharField(max_length=100, blank=True, verbose_name='POD Reference')
